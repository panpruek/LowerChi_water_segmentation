...
BASE_OUTPUT_DIR = r"D:\DL_FN2569\DATA\Model\Loss_comparison\Result\CLOSES2"

PATCH_SIZE = 512
STRIDE = 256 
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
TEST_BLACKOUT_SEN2 = True # ปิดตา Sen-2 ตอนทดสอบ (ถ้าใช้ Sen-122)

# ================= PREPARATION =================
# สร้างชื่อโฟลเดอร์แบบไม่ซ้ำกัน (No Overwrite) พร้อมระบุ Event
timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
run_name = f"Run_{timestamp}_{SOURCE_NAME}_AggressiveMOBILENETCLOSE_CLOSES2_{EVENT_TYPE}"
